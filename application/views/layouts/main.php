    ...
    <div class="wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url('assets/img/avatarm.png');?>" class="user-image"
                                    alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="<?php echo base_url('assets/img/avatarm.png');?>" class="img-circle"
                                        alt="User Image">

                                    <p>
                                        <?= ucwords($this->session->nom_complet) ?> -
                                        <?= ucfirst($this->session->type) ?>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li>
                                <a href="<?php echo site_url('archive/index');?>"><i class="fa fa-list-ul"></i>
                                    Lister</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <?php endif ?>
                <h1>
                    <?= isset($title) ? ucfirst($title) : APP_NAME ?>
        ...
        <footer class="main-footer">
            ...
            <strong>&copy; Copyright <?= date('Y') ?> <a href="<?= base_url() ?>"><?= APP_NAME ?></a></strong> | Tous
            droits réservés
        </footer>
